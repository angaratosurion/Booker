...
namespace Booker.WhiteTigerService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WhiteTigerService.IWhiteTigerService")]
    public interface IWhiteTigerService {
        ...
        void UpdateTable(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<System.Collections.Generic.List<object>> rows);
        ...
        string Decrypt(string root, string recordtag, string username, string dbname, string table, string pass, Hydrobase.Cryptography.CryptograhyAlgorithm alg, Hydrobase.Cryptography.HashingAlogrithm hashalg);
        ...
        void AddRow(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<object> vals, bool autoupd);
        ...
        void AddRows(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<System.Collections.Generic.List<object>> vals, bool autoaupd);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(System.Collections.Generic.List<System.Collections.Generic.List<object>>))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(System.Collections.Generic.List<object>))]
        void AddColumns(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<object> cols, bool autoupd);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWhiteTigerServiceChannel : Booker.WhiteTigerService.IWhiteTigerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WhiteTigerServiceClient : System.ServiceModel.ClientBase<Booker.WhiteTigerService.IWhiteTigerService>, Booker.WhiteTigerService.IWhiteTigerService {
        ...
        public void UpdateTable(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<System.Collections.Generic.List<object>> rows) {
            base.Channel.UpdateTable(root, recordtag, username, pass, dbname, table, rows);
        }
        ...
        public string Decrypt(string root, string recordtag, string username, string dbname, string table, string pass, Hydrobase.Cryptography.CryptograhyAlgorithm alg, Hydrobase.Cryptography.HashingAlogrithm hashalg) {
        ...
        public void AddRow(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<object> vals, bool autoupd) {
            base.Channel.AddRow(root, recordtag, username, pass, dbname, table, vals, autoupd);
        }
        
        public void AddRows(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<System.Collections.Generic.List<object>> vals, bool autoaupd) {
            base.Channel.AddRows(root, recordtag, username, pass, dbname, table, vals, autoaupd);
        }
        ...
        public void AddColumns(string root, string recordtag, string username, string pass, string dbname, string table, System.Collections.Generic.List<object> cols, bool autoupd) {
            base.Channel.AddColumns(root, recordtag, username, pass, dbname, table, cols, autoupd);
        }
    }
}
